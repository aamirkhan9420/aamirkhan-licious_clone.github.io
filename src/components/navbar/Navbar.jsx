...
export default function Navbar({ handleBillforIncreament,setText,locationstate,subtotal, deliverycharge, discount, totalBill, cuurency, handleDeletecard,handleQuantityIncreament,handleQuantityDecreament}) {
...
{/* <Route path="/fishdata" element={<Fish/>}/>
<Route path="/Chicken" element={<Chicken/>}/>
<Route path="/Mutton" element={<Mutton/>}/>
<Route path="/ReadyCook" element={< ReadyCook/>}/>
